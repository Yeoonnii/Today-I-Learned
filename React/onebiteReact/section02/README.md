## 목차
[2.1) Truthy와 Falsy](#ch01.-truthy-와-falsy)<br/>
[2.2) 단락 평가](#ch02.-단락-평가-(short-circuit-evaluation))<br/>
[2.3) 구조 분해 할당](#ch03.-구조-분해-할당)<br/>
[2.4) Spread 연산자와 Rest 매개변수](#ch04.-spread-연산자와-rest-매개변수)<br/>
[2.5) 원시타입 VS 객체타입](#ch05.-원시타입-vs-객체타입)<br/>
[2.6) 반복문으로 배열과 객체 순회하기](#ch06.-반복문으로-배열과-객체-순회하기)<br/>
[2.7) 배열 메서드1. 요소 조작](#ch07.-배열-메서드-1.-요소-조작)<br/>
[2.8) 배열 메서드2. 순회와 탐색](#ch08.-배열-메서드-2.-순회와-탐색)<br/>
[2.9) 배열 메서드 3. 배열 변형](#ch09.-배열-메서드-3.-배열-변형)<br/>
[2.10) Date 객체와 날짜](#ch10.-date-객체와-날짜)<br/>
[2.11) 동기와 비동기](#ch11.-동기와-비동기)<br/>
[2.12) 비동기 작업 처리하기 1. 콜백함수](#ch12.-비동기-작업-처리하기-1.-콜백함수)<br/>
[2.13) 비동기 작업 처리하기 2. Promise](#ch13.-비동기-작업-처리하기-2.-promise)<br/>
[2.14) 비동기 작업 처리하기 3. Async/Await](#ch14.-비동기-작업-처리하기-3.-async/await)<br/>
