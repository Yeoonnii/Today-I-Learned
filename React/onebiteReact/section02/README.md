...
[1.객체타입의 값 변경시 의도치 않게 값이 변경될 수 있다.](img/04.png)


### 얕은복사 / 깊은복사
[얕은복사 / 깊은복사](img/05.png)
...
[2. 객체간의 비교는 참조값을 기준으로 이루어진다.](img/06.png)

### 얕은비교 / 깊은비교
[2. 객체간의 비교는 참조값을 기준으로 이루어진다.](img/07.png)
...
[2. 객체간의 비교는 참조값을 기준으로 이루어진다.](img/08.png)
